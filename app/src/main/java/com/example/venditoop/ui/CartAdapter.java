 ...
 * This Adapter class is responsible for setting up the layout of the Cart page with a recycler
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    /**
     Constructs a CartAdapter object to generate a recycler view with a list of products in the
     user's cart
     @param context the current state of the application (the current screen that the user is on)
     @param cartList a list of Products
     ...
     */
    public CartAdapter(Context context, ArrayList<Product> cartList, RecylcerViewCLickListener listener) {
    ...
    public class Viewholder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public Viewholder(View itemView) {
            ...
            Button increase = itemView.findViewById(R.id.increase);
            Button decrease = itemView.findViewById(R.id.decrease);
            //Set an onClickListener for these buttons so a piece of functionality is executed
            //when a user clicks on the button
            increase.setOnClickListener(this);
            decrease.setOnClickListener(this);

            Button removeButton = itemView.findViewById(R.id.remove_item);
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        ...
        Product model = cartList.get(position);
